...
| metric embedding | Sym | Symmetric metric baseline; L1 distance between the two state encodings (long form "symmetric L1 metric embedding" at first use; Sym as the table shorthand). | symmetric baseline, L1 embedding | fixed |
